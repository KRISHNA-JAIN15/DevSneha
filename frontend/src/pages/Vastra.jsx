...
function Vastra() {
  ...
  const fetchVastraProducts = async () => {
    try {
      setLoading(true);
      const response = await axios.get('/tag/Vastra');
      
      setProducts(response.data);
      setError('');
    } catch (error) {
      console.error('Error fetching vastra products:', error);
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">Loading Vastra Collection...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-pink-50">
      {/* Header Section */}
      <div className="bg-gradient-to-r from-purple-500 to-pink-500 py-16 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
            👗 Vastra Collection
          </h1>
          <p className="text-purple-100 text-lg md:text-xl max-w-2xl mx-auto">
            Discover our exquisite collection of traditional and contemporary clothing for every occasion
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        {products.length === 0 ? (
          <div className="text-center py-16">
            ...
            <h3 className="text-xl font-semibold text-gray-600 mb-2">No Vastra Found</h3>
          ...
          <>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {currentProducts.map((product) => (
                <div
                  key={product._id}
                  className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 overflow-hidden border border-purple-100 hover:border-purple-200"
                >
                  {editingProduct === product._id ? (
                        ...
                        <div>
                          ...
                          {!editImagePreview ? (
                            <div className="relative">
                              ...
                              />
                              <div className="border-2 border-dashed border-purple-300 rounded-lg p-4 text-center hover:border-purple-400 hover:bg-purple-50 transition-all duration-200">
                    ...
                    <>
                      ...
                      <div className="p-6">
                        ...
                        <button 
                          onClick={() => openImageModal(product)}
                          className="w-full px-4 py-3 border border-purple-300 text-purple-600 rounded-lg hover:bg-purple-50 transition-colors duration-200 font-medium"
                        >
                          View Details
                        </button>
                      </div>
            ...
            <div className="flex flex-col md:flex-row">
              ...
              <div className="flex-1 bg-gray-100">
                {selectedImage.imageUrl ? (
                  ...
                  <div className="w-full h-96 md:h-[500px] flex items-center justify-center bg-gradient-to-br from-purple-100 to-pink-100">
              ...
              <div className="md:w-80 p-6 bg-white">
                ...
                <span className="inline-block bg-purple-100 text-purple-700 px-3 py-1 rounded-full font-medium text-sm mb-6">
                  Vastra
                </span>
